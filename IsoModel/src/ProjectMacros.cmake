...
# add a swig target, KEY_I_FILE should include path
macro(MAKE_SWIG_TARGET NAME SIMPLENAME KEY_I_FILE I_FILES PARENT_TARGET PARENT_SWIG_TARGETS)
  ...
  if(BUILD_CSHARP_BINDINGS)
    ...
    set(CSHARP_OUTPUT_NAME "csharp_${NAME}")

    set(NAMESPACE "ISOModel")
    set(MODULE ${LOWER_NAME})
    ...
    # we could get rid of this file list but would require running swig at configure time
    set(CS_FILES
      "${CSHARP_GENERATED_SRC_DIR}/Building.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Cooling.cs"
      "${CSHARP_GENERATED_SRC_DIR}/EndUses.cs"
      "${CSHARP_GENERATED_SRC_DIR}/EndUsesVector.cs"
      "${CSHARP_GENERATED_SRC_DIR}/EpwData.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Heating.cs"
      "${CSHARP_GENERATED_SRC_DIR}/HourlyModel.cs"
      "${CSHARP_GENERATED_SRC_DIR}/isomodel.cs"
      "${CSHARP_GENERATED_SRC_DIR}/isomodelPINVOKE.cs"
      "${CSHARP_GENERATED_SRC_DIR}/KeyGetter.cs"
      "${CSHARP_GENERATED_SRC_DIR}/LatLon.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Lighting.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Location.cs"
      "${CSHARP_GENERATED_SRC_DIR}/MonthlyModel.cs"
      "${CSHARP_GENERATED_SRC_DIR}/PhysicalQuantities.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Population.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Properties.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Simulation.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SimulationSettings.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SolarRadiation.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__numeric__ublas__matrixT_double_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__numeric__ublas__vectorT_double_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__optionalT_bool_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__optionalT_double_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__optionalT_int_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__optionalT_std__string_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_boost__transform_iteratorT_openstudio__isomodel__KeyGetter_std__mapT_std__string_std__string_std__lessT_std__string_t_t__const_iterator_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Building.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Cooling.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_double.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Heating.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_int.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Lighting.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Location.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_PhysicalQuantities.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Population.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_SimulationSettings.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_std__shared_ptrT_EpwData_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_std__shared_ptrT_openstudio__isomodel__EpwData_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_std__shared_ptrT_openstudio__isomodel__WeatherData_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_std__shared_ptrT_WeatherData_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_std__vectorT_double_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_std__vectorT_std__vectorT_double_t_t.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Structure.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_TimeFrame.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Vector.cs"
      "${CSHARP_GENERATED_SRC_DIR}/SWIGTYPE_p_Ventilation.cs"
      "${CSHARP_GENERATED_SRC_DIR}/TimeFrame.cs"
      "${CSHARP_GENERATED_SRC_DIR}/UserModel.cs"
      "${CSHARP_GENERATED_SRC_DIR}/VectorBypass.cs"
      "${CSHARP_GENERATED_SRC_DIR}/Ventilation.cs"
      "${CSHARP_GENERATED_SRC_DIR}/WeatherData.cs"
    )

    add_custom_command(
      OUTPUT ${SWIG_WRAPPER_FULL_PATH} ${CS_FILES}
